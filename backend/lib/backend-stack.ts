...
export class BackendStack extends Stack {
    constructor(scope: Construct, id: string, props?: StackProps) {
        ...
        // --- ADDED CORS OPTIONS for base /auth resource ---
        auth.addMethod(HttpMethod.OPTIONS, new LambdaIntegration(cors_lambda));
        ...
        // --- ADDED CORS OPTIONS for /auth/verify-token ---
        verify_token.addMethod(HttpMethod.OPTIONS, new LambdaIntegration(cors_lambda));

        // /auth/login
        const login = auth.addResource("login");
        login.addMethod(HttpMethod.POST, new LambdaIntegration(login_lambda));
        // --- ADDED CORS OPTIONS for /auth/login ---
        login.addMethod(HttpMethod.OPTIONS, new LambdaIntegration(cors_lambda));

        // /auth/sign-up
        const signup = auth.addResource("sign-up");
        signup.addMethod(HttpMethod.POST, new LambdaIntegration(signup_lambda));
        // --- ADDED CORS OPTIONS for /auth/sign-up ---
        signup.addMethod(HttpMethod.OPTIONS, new LambdaIntegration(cors_lambda));
        ...
        // --- ADDED CORS OPTIONS for base /proposal resource ---
        proposal.addMethod(HttpMethod.OPTIONS, new LambdaIntegration(cors_lambda));
        ...
        // --- ADDED CORS OPTIONS for /proposal/create ---
        create_proposal.addMethod(HttpMethod.OPTIONS, new LambdaIntegration(cors_lambda));
        ...
        // --- ADDED CORS OPTIONS for /forward-proposal-to-evaluators ---
        proposal_forward_to_evaluators.addMethod(HttpMethod.OPTIONS, new LambdaIntegration(cors_lambda));
        ...
        // --- ADDED CORS OPTIONS for /forward-proposal-to-rnd ---
        proposal_forward_to_rnd.addMethod(HttpMethod.OPTIONS, new LambdaIntegration(cors_lambda));
        ...
        // --- ADDED CORS OPTIONS for /proposal/view ---
        get_proposal.addMethod(HttpMethod.OPTIONS, new LambdaIntegration(cors_lambda));
        ...
        // --- ADDED CORS OPTIONS for /proposal/view-evaluator ---
        get_proposal_evaluator.addMethod(HttpMethod.OPTIONS, new LambdaIntegration(cors_lambda));
        ...
        // --- ADDED CORS OPTIONS for stats routes ---
        get_proponent_proposal_stats.addMethod(HttpMethod.OPTIONS, new LambdaIntegration(cors_lambda));
        ...
        // --- ADDED CORS OPTIONS for stats routes ---
        get_rnd_proposal_stats.addMethod(HttpMethod.OPTIONS, new LambdaIntegration(cors_lambda));
        ...
        // --- ADDED CORS OPTIONS for stats routes ---
        get_evaluator_proposal_stats.addMethod(HttpMethod.OPTIONS, new LambdaIntegration(cors_lambda));
        ...
        // --- ADDED CORS OPTIONS for /view-agency ---
        get_agency.addMethod(HttpMethod.OPTIONS, new LambdaIntegration(cors_lambda));
        ...
        // --- ADDED CORS OPTIONS for /view-cooperating-sector ---
        get_cooperating_agency.addMethod(HttpMethod.OPTIONS, new LambdaIntegration(cors_lambda));
        ...
        // --- ADDED CORS OPTIONS for /view-department ---
        get_department.addMethod(HttpMethod.OPTIONS, new LambdaIntegration(cors_lambda));
        ...
        // --- ADDED CORS OPTIONS for /view-discipline ---
        get_discipline.addMethod(HttpMethod.OPTIONS, new LambdaIntegration(cors_lambda));
        ...
        // --- ADDED CORS OPTIONS for /view-sector ---
        get_sector.addMethod(HttpMethod.OPTIONS, new LambdaIntegration(cors_lambda));
        ...
        // --- ADDED CORS OPTIONS for /view-tag ---
        get_tag.addMethod(HttpMethod.OPTIONS, new LambdaIntegration(cors_lambda));
    }
}