  ...
  async getAll(search?: string, status?: Status, proponent_id?: string, roles?: string[]) {
    let query = this.db.from("proposals").select(`
      *,
      ...
      proponent_id(id,first_name,middle_ini,last_name,email,photo_profile_url,department:department_id(name)),
      ...
      .select(
        ...
        proposal_id(
          *,
          ...
          proposal_priorities(priorities(id,name)),
          implementation_site(site_name,city),
          proponent_id(id,first_name,middle_ini,last_name,department:department_id(name)),
          rnd_station:departments(name),
          sector:sectors(name),
          discipline:disciplines(name),
          agency:agencies(name),
