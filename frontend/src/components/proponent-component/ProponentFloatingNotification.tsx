...
interface ProponentFloatingNotificationProps {
  onPageChange: (page: string) => void;
}

const ProponentFloatingNotification: React.FC<ProponentFloatingNotificationProps> = ({ onPageChange }) => {
...
export default ProponentFloatingNotification;
