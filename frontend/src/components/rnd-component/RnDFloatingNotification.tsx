...
interface RnDFloatingNotificationProps {
  onPageChange: (page: string) => void;
}

const RnDFloatingNotification: React.FC<RnDFloatingNotificationProps> = ({ onPageChange }) => {
...
export default RnDFloatingNotification;
