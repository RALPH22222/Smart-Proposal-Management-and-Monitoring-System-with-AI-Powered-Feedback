        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              {/* Featured Projects removed from here */}
              <li><a href="/download" className="text-gray-600 hover:text-red-700 transition-colors duration-200 flex items-center gap-2">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="space-y-3 mb-6">
              <div className="flex items-center gap-3 text-gray-600">
                ...
                <span className="break-words">
                  {contactData?.emails.research || "research@wmsu.edu.ph"}
                </span>
              </div>
              <div className="flex items-center gap-3 text-gray-600">
                <svg className="w-5 h-5 text-red-600 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span>{contactData?.phones.main || "+63 (62) 991-4567"}</span>
              </div>
              <div className="flex items-start gap-3 text-gray-600">
                ...
                <span>
                  ...
                  {contactData?.location.details ? `, ${contactData?.location.details}` : ''}
                </span>
              </div>
            </div>
            <a
              href={`mailto:${contactData?.emails.research || "research@wmsu.edu.ph"}`}
