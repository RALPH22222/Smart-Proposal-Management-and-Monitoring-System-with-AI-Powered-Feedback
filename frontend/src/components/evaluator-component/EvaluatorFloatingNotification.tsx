...
interface EvaluatorFloatingNotificationProps {
  onPageChange: (page: string) => void;
}

const EvaluatorFloatingNotification: React.FC<EvaluatorFloatingNotificationProps> = ({ onPageChange }) => {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50" ref={notifRef}>
      ...
      {/* Notifications Dropdown - Positioned relative to the button */}
...
export default EvaluatorFloatingNotification;
