...
const EvaluatorSettings: React.FC = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8 animate-fade-in">
      ...
      {/* ── Page Header ── */}
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-gray-900">Evaluator Settings</h1>
        <p className="text-sm text-gray-500 mt-1">Manage your evaluator account, department, and security preferences.</p>
      </div>
      ...
      {activeTab === 'email' && (
        <form onSubmit={onSaveEmail}>
          <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6">
            ...
            <div className="mb-4">
              <FormInput label="Primary Email" type="email" value={emailValue} onChange={(e) => setEmailValue(e.target.value)} placeholder="e.g. evaluator@example.com" required suffix={<Mail size={15} className="text-gray-400" />} />
            </div>
