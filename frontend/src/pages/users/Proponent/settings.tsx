...
const Settings: React.FC = () => {
  ...
  return (
    <div className="min-h-screen px-5 sm:px-8 lg:px-10 xl:px-12 2xl:px-16 py-8 lg:py-10 font-sans bg-gradient-to-br from-slate-50 to-slate-100 animate-fade-in">
