    ...
    <div className="flex flex-col h-full overflow-hidden">
      <div className="flex-1 overflow-y-auto">
        <div className="p-4 sm:p-6">
          ...
          {/* Filters */}
          <section className="bg-white rounded-lg shadow p-3 sm:p-4 mb-6 border border-gray-100">
          ...
          <section className="bg-white rounded-lg shadow border border-gray-100">
            ...
            <div className="hidden md:block overflow-x-auto">
              <table className="min-w-full table-auto">
                <thead>
                  <tr className="text-left text-xs text-gray-500 border-b bg-gray-50/50">
                    ...
                    <th className="px-3 sm:px-4 py-3 font-medium">Action</th>
                  </tr>
                </thead>
                <tbody>
                  {paginated.map((i) => (
                    <tr key={i.id} className="border-b last:border-b-0 hover:bg-gray-50/50 transition-colors">
                      ...
                      <td className="px-3 sm:px-4 py-3">
                        <button
                          className="px-3 py-1.5 text-xs rounded-md text-white hover:opacity-90 transition-opacity"
                          style={{ backgroundColor: accent }}
                        >
                          View
                        </button>
              ...
              {/* Pagination */}
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 px-3 sm:px-4 py-3 bg-gray-50/30 border-t border-gray-100">
                <div className="text-xs text-gray-500">
                  Showing {total === 0 ? 0 : startIdx + 1}–{endIdx} of {total}
                </div>
                <div className="flex items-center gap-2">
                  <button
                    className="px-3 py-1.5 text-sm rounded border border-gray-200 disabled:opacity-50 bg-white hover:bg-gray-50"
            ...
            <div className="md:hidden divide-y divide-gray-100">
              {paginated.map((i) => (
                <div key={i.id} className="p-3 sm:p-4">
                  ...
                  <div className="mt-3">
                    <button
                      className="w-full px-3 py-2 text-sm rounded-md text-white shadow-sm"
                      style={{ backgroundColor: accent }}
                    >
                      View Details
                    </button>
              ...
              {/* Mobile pagination */}
              <div className="flex items-center justify-between gap-2 px-3 sm:px-4 py-3 border-t border-gray-100 bg-gray-50/30">
                <div className="text-xs text-gray-500">
                  {total === 0 ? 0 : startIdx + 1}–{endIdx} of {total}
                </div>
                <div className="flex items-center gap-2">
                  <button
                    className="px-3 py-1.5 text-sm rounded border border-gray-200 disabled:opacity-50 bg-white"
                    onClick={() => setPage((p) => Math.max(1, p - 1))}
                    disabled={pageSafe <= 1}
                  >
                    Prev
          ...
          <div className="bg-white rounded-lg w-full max-w-2xl max-h-[90vh] overflow-y-auto shadow-xl">
            ...
            <div className="p-4 sm:p-6 space-y-4">
              <div>
                ...
                <input
                  type="text"
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-red-500 text-sm transition-shadow"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <select className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-red-500 text-sm bg-white transition-shadow">
              ...
              <div className="flex gap-3 pt-4 border-t border-gray-100 mt-4">
                <button
                  className="flex-1 bg-red-600 text-white px-4 py-2 rounded-md hover:bg-red-700 transition-colors text-sm font-medium shadow-sm"
                  style={{ backgroundColor: accent }}
                >
                  Submit Report
                </button>
                <button
                  onClick={() => setShowNewReportModal(false)}
                  className="flex-1 bg-white border border-gray-300 text-gray-700 px-4 py-2 rounded-md hover:bg-gray-50 transition-colors text-sm font-medium"
                >
                  Cancel
                </button>
              </div>
