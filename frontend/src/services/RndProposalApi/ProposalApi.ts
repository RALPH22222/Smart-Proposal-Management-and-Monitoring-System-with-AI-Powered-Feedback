...
const getDummyProposals = (): Proposal[] => [
  {
    ...
    description: 'A proposal to develop an AI-powered platform to analyze student learning patterns and improve academic outcomes.',
    status: 'Pending',
  ...
  },
  {
    ...
    documentUrl: 'https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf',
    description: 'A proposal focused on creating a sustainable water management system leveraging IoT devices and machine learning algorithms to optimize water usage.',
  ...
  },
  {
    ...
    documentUrl: 'https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf',
    description: 'This proposal aims to develop a blockchain-based system for secure and efficient verification of academic credentials.',
  ...
  },
  {
    ...
    documentUrl: 'https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf',
    description: 'A proposal to create a mobile application for remote health monitoring and patient care, utilizing wearable devices and real-time data analytics.',
    status: 'Pending',
  ...
  },
  {
    ...
    documentUrl: 'https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf',
    description: 'This proposal outlines the development of a smart security system for campuses using advanced facial recognition technology to enhance safety and security measures.',
  ...
  },
  {
    ...
    documentUrl: 'https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf',
    description: 'A proposal to develop a virtual reality learning environment aimed at enhancing STEM education through immersive experiences.',
    status: 'Pending',
